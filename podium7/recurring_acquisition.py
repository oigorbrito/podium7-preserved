...
class RecurringAcquisitionCoordinator:
    ...
    def record_success(
        ...
        *,
        ...
        # Preserve the existing source-data safety/drift gates as the first authority.
        # Terms review must never mask host/hash/media/schema drift in the acquired source data.
