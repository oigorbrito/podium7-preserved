...
Acceptance: all 13 current reviews explicitly dispositioned, zero unassessed/stale dispositions, zero resolver-policy changes, and green CI on the PR merge candidate before integration.
