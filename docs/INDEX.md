...
- [`PODIUM7-PRODUCTIVE-COVERAGE-WAVE-02.md`](PODIUM7-PRODUCTIVE-COVERAGE-WAVE-02.md) - current-main Brazilian quantitative productive-coverage decision for BPT2 technical-sheet readiness.
