...
- [`BATCH-FAILURE-RETENTION-V1.md`](BATCH-FAILURE-RETENTION-V1.md) — durable immutable diagnostic snapshots for per-record catalog ingestion failures, separate from valid evidence and publication state.
