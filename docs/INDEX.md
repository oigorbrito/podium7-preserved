...
- [`MULTISOURCE-CONFLICT-DISPOSITION-V1.md`](MULTISOURCE-CONFLICT-DISPOSITION-V1.md) — explicit conflict-state observability for bounded multi-source validation without changing fusion semantics.
